...
public class TwitterClient extends OAuthBaseClient {
	...
	// parameter max id used to determine the oldest tweet in the current list, so that
	// the get call can return the next 25 tweets after the current oldest tweet in the timeline
	...
	public void publishRetweet(JsonHttpResponseHandler handler, long tweetId) {
	...
	public void publishUnretweet(JsonHttpResponseHandler handler, long tweetId) {
